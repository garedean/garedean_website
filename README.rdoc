...
See it live: https://thawing-inlet-3560.herokuapp.com/projects
...
1. Navigate to https://thawing-inlet-3560.herokuapp.com/users/sign_in
2. username:
3. password: 

My goal is to have user authentication only be required for Admins, so I am hiding the 'Login' link so visitors don't see it. To login, visit the '/users/sign_in' path.
