...
Note: at the expense of lower marks for the assessment, I decided to use a different layout for my portfolio site. My version doesn't have multiple layers (skills with nested projects then nested details): that seemed very click-heavy to me, and I want a prospective employer to be able to see all of the main points on a single page. Since my version had more limited functionality, I spent much of the time on styling and UI.

My version has a 'Projects page' with CRUD functionality. My plan is to simply nest technologies used during development in the description of each project.
